...
button_5 = Button(root, text = '4', padx = 40, pady = 20, command = lambda: click_handler(5))
button_6 = Button(root, text = '4', padx = 40, pady = 20, command = lambda: click_handler(6))
button_7 = Button(root, text = '5', padx = 40, pady = 20, command = lambda: click_handler(7))
button_8 = Button(root, text = '6', padx = 40, pady = 20, command = lambda: click_handler(8))
button_9 = Button(root, text = '7', padx = 40, pady = 20, command = lambda: click_handler(9))
button_0 = Button(root, text = '8', padx = 40, pady = 20, command = lambda: click_handler(0))
button_add = Button(root, text = '+', padx = 39, pady = 20)
button_equal = Button(root, text = '=', padx = 39, pady = 20)
button_clear = Button(root, text = 'Clear', padx = 39, pady = 20)
